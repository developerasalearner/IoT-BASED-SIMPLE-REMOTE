...
void Lcd::begin(uint8_t cols, uint8_t lines, uint8_t addr, uint8_t backlight)
{
 ...
 *  
 */
void Lcd::selectLine(uint8_t line)
{
  setCursor(0, line - 1);
}
...
void Lcd::scrollDisplayLeft(int charsToScroll, int scrollSpeed) {
...
void Lcd::scrollDisplayRight(int charsToScroll, int scrollSpeed) {
  for (int i=0 ; i < charsToScroll ; i++)
    {
...
void Lcd::_sendNibble(uint8_t halfByte, uint8_t mode) {
...
void Lcd::_write2Wire(uint8_t halfByte, uint8_t mode, uint8_t enable) {
